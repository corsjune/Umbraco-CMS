...
{
    /// <summary>
    /// Parameter class for the PostgresHelper.
    /// </summary>
    public class PostgreSQLParameter : SqlParameterAdapter<PostgreSQLClient.NpgsqlParameter>
    {
        ...
        public PostgreSQLParameter(string parameterName, object value)
            : base(new PostgreSQLClient.NpgsqlParameter(CorrectParameterName(parameterName), value))
        { }
        ...
        /// <summary>
        /// Changes the parameter name to the Postgres equivalent.
        /// </summary>
