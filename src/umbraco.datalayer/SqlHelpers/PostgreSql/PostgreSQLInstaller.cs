...
{
    /// <summary>
    /// Database installer for an Postgres data source.
    /// </summary>
    [Obsolete("This is not used and will be removed in future versions")]
    public class PostgreSQLInstaller : DefaultInstallerUtility<PostgreSQLHelper>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostgreSQLInstaller"/> class.
        /// </summary>
        /// <param name="sqlHelper">The SQL helper.</param>
        public PostgreSQLInstaller(PostgreSQLHelper sqlHelper)
